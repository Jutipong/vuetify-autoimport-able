...
import { getDarkText, getPrimary } from '../../../forms/charts/apex-chart/UpdateColors'
    ...
    <v-card variant="outlined" class="bg-surface" rounded="lg">
        ...
        <v-card-item class="pt-0">
            <div class="apexchart-center">
                <apexchart type="donut" height="300" :options="chartOptions" :series="pieChart.series" />
            </div>
            <v-row class="mt-2">
                <v-col v-for="(item, index) in overviewList" :key="index" cols="12" sm="6">
                    <v-sheet rounded="lg" class="pa-4" color="containerBg">
                        <p class="text-body-1 mb-0">
                            <v-avatar size="8" :color="item.color" variant="flat" class="mr-2" />
                            {{ item.name }}
                        </p>
