...
<template>
    <v-card variant="outlined" class="bg-surface" rounded="lg">
            ...
            <div class="d-flex justify-space-between align-center">
                ...
                <v-menu width="150">
                    ...
                    <v-list elevation="24" class="pa-3" rounded="md" aria-busy="true" aria-label="menu">
                        <v-list-item v-for="(item, index) in menulist" :key="index" density="compact" rounded="md" color="secondary" :value="index">
        ...
        <v-tabs v-model="tab" color="primary" class="px-6">
            <v-tab value="one" class="font-weight-medium">
                All transaction
            </v-tab>
            <v-tab value="two" class="font-weight-medium">
                Success
            </v-tab>
            <v-tab value="three" class="font-weight-medium">
                Pending
            </v-tab>
        </v-tabs>
        <v-divider />
            ...
            <v-window v-model="tab">
                <v-window-item value="one">
                    <v-list border rounded="lg" class="py-0" aria-busy="true" aria-label="transaction data">
                        <v-list-item v-for="(item, i) in transactionData" :key="i" class="py-4 px-6">
                            <template #prepend>
                                <v-avatar v-if="item.avatarVariant == 'tonal'" size="40" :color="item.avatarColor" variant="tonal" rounded="md">
                                    <span class="text-h5">
                                        {{ item.avatarName }}
                                    </span>
                                </v-avatar>
                ...
                <v-window-item value="two">
                    <v-list border rounded="lg" class="py-0">
                        <v-list-item v-for="(item, i) in transactionData1" :key="i" class="py-4 px-6">
                            <template #prepend>
                                <v-avatar v-if="item.avatarVariant == 'tonal'" size="40" :color="item.avatarColor" variant="tonal" rounded="md">
                                    <span class="text-h5">
                                        {{ item.avatarName }}
                ...
                <v-window-item value="three">
                    <v-list border rounded="lg" class="py-0">
                        <v-list-item v-for="(item, i) in transactionData2" :key="i" class="py-4 px-6">
                            <template #prepend>
                                <v-avatar v-if="item.avatarVariant == 'tonal'" size="40" :color="item.avatarColor" variant="tonal" rounded="md">
                                    <span class="text-h5">
                                        {{ item.avatarName }}
