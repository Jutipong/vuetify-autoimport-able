...
<template>
    ...
    <v-form ref="logform" v-model="valid" lazy-validation class="mt-7 loginForm">
        <v-otp-input v-model="otp" type="number" length="4" class="mb-5" rounded="md" single-line height="46" />
        <v-btn color="primary" block class="mt-2" variant="flat" rounded="md" size="large" type="submit">
            Continue
        </v-btn>
    </v-form>
