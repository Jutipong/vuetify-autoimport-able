...
<template>
    <div class="d-flex justify-space-between align-center">
        ...
        <router-link to="/auth/login1" class="text-primary text-decoration-none">
    ...
    <v-form ref="Regform" lazy-validation action="/dashboards/analytical" class="mt-7 loginForm">
        ...
        <div class="mb-6">
            ...
            <v-text-field hide-details="auto" variant="outlined" class="mt-2" color="primary" placeholder="Demo Inc." />
        </div>
        <div class="mb-6">
        ...
        <div class="d-sm-inline-flex align-center mt-2 mb-7 mb-sm-0 font-weight-bold">
            <h6 class="text-caption">
                ...
                <router-link to="/auth/register1" class="text-primary link-hover font-weight-medium">
                    Terms of Service
                </router-link>
                and
                <router-link to="/auth/register1" class="text-primary link-hover font-weight-medium">
        ...
        <v-btn color="primary" block class="mt-4" variant="flat" rounded="md" size="large" @click="validate()">
            Create Account
        </v-btn>
    </v-form>
</template>
